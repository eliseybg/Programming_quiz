...
import com.breaktime.programmingquiz.CreateQuestions.FindMatchQuestions;
...
public class FindMatch extends AppCompatActivity {
    ...
    private ArrayList<FindMatchQuestions.Node> list;
    private FindMatchQuestions questionList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_find_a_match);
        getSettings();
        setView();
        questionList = new FindMatchQuestions(this);
    ...
    private void getSettings() {
        ...
        if (settings.getSettings(SaveAndLoadSettings.FIND_MATCH_QUESTIONS)) {
        ...
        timer = settings.getSettings(SaveAndLoadSettings.FIND_MATCH_TIMER);
    ...
    void setQuestion() {
        ...
        image.setImageResource(list.get(current).image);
