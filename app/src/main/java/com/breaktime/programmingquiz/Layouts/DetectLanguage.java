...
import com.breaktime.programmingquiz.CreateQuestions.HelloWorldQuestions;
...
public class DetectLanguage extends AppCompatActivity {
    ...
    private ArrayList<HelloWorldQuestions.Node> list;
    private HelloWorldQuestions questionList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detect_language);
        getSettings();
        setView();
        questionList = new HelloWorldQuestions(this);
    ...
    private void getSettings() {
        ...
        if (settings.getSettings(SaveAndLoadSettings.DETECT_LANGUAGE_QUESTIONS)) {
            arrange = new int[]{47, 44, 40};
            amountOfQuestions = 50;
        } else {
            arrange = new int[]{10, 9, 7};
            amountOfQuestions = 10;
        }
        timer = settings.getSettings(SaveAndLoadSettings.DETECT_LANGUAGE_TIMER);
